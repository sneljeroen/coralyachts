                    ...
                    <div class="r-nav-section float-right">
                      <nav>
                        <ul>
                          ...
                          <li class="r-has-child">
                            <a href="yachts">VEHICLES</a>
                            <ul class="pl-0 ml-0">
                              <li><a href="listing">Car Listing</a></li>
                              <li><a href="booking">Car Booking</a></li>
                            </ul>
                          </li>
        ...
        <div id="r-insurance-part" class="r-insurance-part">
          <div class="container">
            ...
            <div class="r-insurance-btn-part">
              <a href="listing" title="" class="btn-primary">VIEW ALL VEHICLES</a>
              <a href="purchases" title="" class="btn-default">RESERVED CAR</a>
            </div>
          </div>
        </div>
